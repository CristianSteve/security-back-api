const template = {
    alert : ({ nombre, area, fecha, hora}) => {
        ...
        font-size: 1rem;font-weight: 400;line-height: 1.5;color: #212529;background-color: #fff;-webkit-text-size-adjust: 100%;-webkit-tap-highlight-color: transparent;">
            ...
            <div style="box-sizing: border-box;background-color: #da8433;color: #fff!important;text-align: center!important;padding: 1.5rem!important;margin-top: 3rem!important;">
                <p style="text-align:center;box-sizing: border-box;margin: 0!important;">Derechos Reservados por Windoor Security</p>
                <p style="text-align:center;box-sizing: border-box;margin: 0!important;">Con el apoyo de la universidad Compensar</p>
                <p style="text-align:center;"><b>Proyecto Semillero STEAM</b></p>
		    </div>
        </body>
        </html>`
    },
        ...
        font-size: 1rem;font-weight: 400;line-height: 1.5;color: #212529;background-color: #fff;-webkit-text-size-adjust: 100%;-webkit-tap-highlight-color: transparent;">
            <div style="box-sizing: border-box;width: 100%;padding-right: 0.75rem;padding-left: 0.75rem;margin-right: auto;margin-left: auto;">
                ...
                <div style="box-sizing: border-box;margin: 1.5rem !important;">
                    ...
                    <p>Cordial Saludo</p>
                    <p>Nos permitimos informale que por parte de <b>WinDoor Security</b> se le ha invitado a unirse al monitoreo del area privada.</p>
                </div>
                <div style="box-sizing: border-box;padding: 0.5rem!important;background-color: rgb(235, 235, 235);">
    ...
    settings({nombre, fecha, hora}){
        ...
        font-size: 1rem;font-weight: 400;line-height: 1.5;color: #212529;background-color: #fff;-webkit-text-size-adjust: 100%;-webkit-tap-highlight-color: transparent;">
            <div style="box-sizing: border-box;width: 100%;padding-right: 0.75rem;padding-left: 0.75rem;margin-right: auto;margin-left: auto;">
                ...
                <img style="box-sizing: border-box;width: 100%" src="https://i.ibb.co/nbG6yJr/settings.png" alt="logo"/>
                <div style="box-sizing: border-box;margin: 1.5rem !important;">
                    <h2 style="box-sizing: border-box;text-align: center!important; padding: 1.5rem !important;">Cambio de configuración</h2>
                    <p>Cordial Saludo, <b>${nombre}</b></p>
                    <p>Le notificamos que se ha realizado cambios en su configuracion personal del aplicativo <b>Windoor Security</b> a las ${hora} del ${fecha}</p>
                    <br />
                </div>
                <div style="box-sizing: border-box;text-align: center!important;color: #ffffff;background-color: #ef5e5e;border-color: #ff0000;position: relative;padding: 1rem 1rem;margin-bottom: 1rem;border: 1px solid transparent;border-radius: 0.25rem;font-size: 0.75rem">
                    <span>Si usted no lo ha realizado, por favor contactese con el administrador y cambie las credenciales de su cuenta.</span>    
                </div>
            </div>
            <div style="box-sizing: border-box;background-color: #da8433;color: #fff!important;text-align: center!important;padding: 1.5rem!important;margin-top: 3rem!important;">
                <p style="text-align:center;box-sizing: border-box;margin: 0!important;">Derechos Reservados por Windoor Security</p>
